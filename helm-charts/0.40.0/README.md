...
3. Install VMware Secrets Manager using Helm:
    ...
    ```bash
    helm install vsecm vsecm/vsecm --version 0.40.0
    ```
...
```bash
helm install vsecm vsecm/helm-charts --version 0.40.0 \
...
|------------|------|---------|
| file://charts/keystone | keystone | 0.40.0 |
| file://charts/safe | safe | 0.40.0 |
| file://charts/sentinel | sentinel | 0.40.0 |
| file://charts/spire | spire | 0.40.0 |
...
| global.images | object | `{"initContainer":{"repository":"vsecm-init-container","tag":"0.40.0"},"keystone":{"distrolessFipsRepository":"vsecm-fips-keystone","distrolessRepository":"vsecm-keystone","pullPolicy":"IfNotPresent","tag":"0.40.0"},"nodeDriverRegistrar":{"pullPolicy":"IfNotPresent","repository":"registry.k8s.io/sig-storage/csi-node-driver-registrar","tag":"v2.10.0"},"openShiftHelperUbi9":{"pullPolicy":"IfNotPresent","repository":"registry.access.redhat.com/ubi9","tag":"latest"},"safe":{"distrolessFipsRepository":"vsecm-fips-safe","distrolessRepository":"vsecm-safe","pullPolicy":"IfNotPresent","tag":"0.40.0"},"sentinel":{"distrolessFipsRepository":"vsecm-fips-sentinel","distrolessRepository":"vsecm-sentinel","pullPolicy":"IfNotPresent","tag":"0.40.0"},"spiffeCsiDriver":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/spiffe/spiffe-csi-driver","tag":"0.2.6"},"spireAgent":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/spiffe/spire-agent","tag":"1.9.6"},"spireControllerManager":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/spiffe/spire-controller-manager","tag":"0.5.0"},"spireHelperBash":{"pullPolicy":"IfNotPresent","repository":"cgr.dev/chainguard/bash","tag":"latest@sha256:8c9e5cbb641ced8112c637eb3611dab29bf65448a9d884a03938baf1b352dc4d"},"spireHelperKubectl":{"pullPolicy":"IfNotPresent","repository":"docker.io/rancher/kubectl","tag":"v1.28.0"},"spireServer":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/spiffe/spire-server","tag":"1.9.6"}}` | Where to find the dependent images of VSecM. Normally, you would not need to modify this. |
...
| global.preInstallVSecMNamespaces | bool | `true` | Set it to true to enable the pre-installation of the VSecM namespaces. If set to false, the VSecM namespaces will not be pre-installed; you will need to create a `vsecm` namespace manually. |
...
| global.vsecm.namespace | string | `"vsecm"` |  |
| global.vsecm.safeEndpointUrl | string | `"https://vsecm-safe.vsecm.svc.cluster.local:8443/"` |  |
| global.vsecm.safeSpiffeIdPrefix | string | `"^spiffe://vsecm.com/workload/vsecm-safe/ns/vsecm/sa/vsecm-safe/n/[^/]+$"` |  |
...
| global.vsecm.sentinelSpiffeIdPrefix | string | `"^spiffe://vsecm.com/workload/vsecm-sentinel/ns/vsecm/sa/vsecm-sentinel/n/[^/]+$"` |  |
